...
public class BmpServiceIntegrationTest {
    ...
    void testHappyPathFullProtocolAndBroadcast() throws InterruptedException {
        ...
        InitializeRequest aliceInitReq =
                InitializeRequest.newBuilder()
                        .setTradeId("alice_mock_trade_id_1")
                        .setRole(Role.SELLER)
        ...
        InitializeRequest bobInitReq =
                InitializeRequest.newBuilder()
                        .setTradeId("bob_mock_trade_id_1")
                        .setRole(Role.BUYER)
        ...
        System.out.println(
                "Raw TX Hex: " + rawTx.substring(0, Math.min(80, rawTx.length())) + "...");
    }
